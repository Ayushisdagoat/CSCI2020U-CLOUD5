...
public class GameService {
    ...
    public boolean editPrice(int id, double newPrice) {
        ...
        System.out.println("Price updated for '" + titles.get(index) + "' → $" + newPrice);
        return true;
    }
    ...
    // Return individual fields for a game at a given index.
